...
def wordparse(wd : str, lsflag : int, wfflag : int, clearflag : int):
    ...
    #g.words.syllabifiedWordOut = MiddleVowel(g, g.words.syllabifiedWordOut) #commented for santali language included in original script
    #g.words.syllabifiedWordOut = Syllabilfy(g.words.syllabifiedWordOut)
    #g.words.syllabifiedWordOut="&k&av&a&m&av&l"  #added by pranaw for santali
...
if __name__ == '__main__':
    ...
    print("jnh1")
    with open("wordpronunciation", "w") as file:
    	print(ans, file=file)
    print(ans)
    print("jnh2")
